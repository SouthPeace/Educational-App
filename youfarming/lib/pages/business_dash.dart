...
class BusinessDashboard2 extends StatefulWidget {
  @override
  _BusinessDashboard2State createState() => _BusinessDashboard2State();
}

class _BusinessDashboard2State extends State<BusinessDashboard2> {
  double gPercent = 0;
  List<Widget> widgets = [];
